<x-layout title="Analisis Trend">
    <h1 class="fw-bold">Analisis Trend</h1>
    ...
    <div class="analisis-stok mt-4">
        <h3 class="fw-bold text-center">Laporan Penjualan Stok</h3>
        <div class="d-flex justify-content-center gap-3 mt-3">
        <div class="dropdown">
            <button class="btn dropdown-toggle fw-semibold fs-5" type="button" id="monthDropdownButton" data-bs-toggle="dropdown" aria-expanded="false">Pilih Waktu</button>
            <ul class="dropdown-menu" aria-labelledby="yearDropdownButton">
                <li><a class="dropdown-item" href="{{ route('analisisTrend', ['rangeWaktu' => 'bulanan']) }}">Bulanan</a></li>
                <li><a class="dropdown-item" href="{{ route('analisisTrend', ['rangeWaktu' => 'mingguan']) }}">Mingguan</a></li>
                <li><a class="dropdown-item" href="{{ route('analisisTrend', ['rangeWaktu' => 'tahunan']) }}">Tahunan</a></li>
            </ul>
        </div>
    </div>
